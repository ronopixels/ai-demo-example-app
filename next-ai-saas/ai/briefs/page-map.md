...
**Legend:** MVP = first commercial slice; Later = post-MVP.

---

## A. Marketing (public)

| Page | Route (example) | MVP |
|------|-----------------|-----|
| Home v1 | `/` | ✓ |
| Home v2 / v3 | `/` (demo swap) | Later |
| About | `/about` | ✓ |
| Features | `/features` | ✓ |
...
| Reset password | `/reset-password` | Later |
| Verify email | `/verify-email` | Later |
| Two-step verification | `/2fa` | Later |
| Coming soon / waitlist | `/coming-soon` | Later |
