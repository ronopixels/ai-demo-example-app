...
- **Rules**: `.cursor/rules/` (and `.claude/rules/` for the same standards): App Router, Tailwind v4, components, data, folder structure. **Icons**: use **`@phosphor-icons/react`** whenever the UI needs icons — see **`25-phosphor-icons.mdc`**.
